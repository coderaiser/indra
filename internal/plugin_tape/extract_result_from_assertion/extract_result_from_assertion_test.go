...
func TestExtractResultFromAssertion(t *testing.T) {
	Test(t, "extract-result-from-assertion: report inline call", func(t *T) {
		t.Report("extract-result-from-assertion", "extract inline expression from assertion")
		t.End()
	})

	Test(t, "extract-result-from-assertion: transform inline call", func(t *T) {
	...
	Test(t, "extract-result-from-assertion: no report when result already declared", func(t *T) {
		t.NoReport("result-declared")
		t.End()
	})

	Test(t, "extract-result-from-assertion: no transform when result already declared", func(t *T) {
