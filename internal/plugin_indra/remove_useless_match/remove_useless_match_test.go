...
func TestRemoveUselessMatch(t *testing.T) {
	...
	Test(t, "remove-useless-match: no report mixed guards mixed-guards", func(t *T) {
		t.NoReport("mixed-guards")
		t.End()
	})

	Test(t, "remove-useless-match: no transform mixed guards mixed-guards", func(t *T) {
		t.NoTransform("mixed-guards")
		t.End()
	})

	Test(t, "remove-useless-match: no report wrong return type wrong-return-type", func(t *T) {
		t.NoReport("wrong-return-type")
		t.End()
	})

	Test(t, "remove-useless-match: no transform wrong return type wrong-return-type", func(t *T) {
		t.NoTransform("wrong-return-type")
		t.End()
	})

	Test(t, "remove-useless-match: no report non composite return non-composite-return", func(t *T) {
		t.NoReport("non-composite-return")
		t.End()
	})

	Test(t, "remove-useless-match: no transform non composite return non-composite-return", func(t *T) {
		t.NoTransform("non-composite-return")
		t.End()
	})

	Test(t, "remove-useless-match: no report no results no-results", func(t *T) {
		t.NoReport("no-results")
		t.End()
	})

	Test(t, "remove-useless-match: no report non return body non-return-body", func(t *T) {
		t.NoReport("non-return-body")
		t.End()
	})

	Test(t, "remove-useless-match: no report ident return ident-return", func(t *T) {
