...
func TestRemoveBoolean(t *testing.T) {
	Test(t, "conditions/remove-boolean: report: remove-boolean", func(t *T) {
		t.Report("remove-boolean", "remove boolean")
		t.End()
	})

	Test(t, "conditions/remove-boolean: transform: remove-boolean", func(t *T) {
		t.Transform("remove-boolean")
		t.End()
	})

	Test(t, "conditions/remove-boolean: transform: not-equal-false", func(t *T) {
		t.Transform("not-equal-false")
		t.End()
	})

	Test(t, "conditions/remove-boolean: transform: equal-false", func(t *T) {
		t.Transform("equal-false")
		t.End()
	})

	Test(t, "conditions/remove-boolean: transform: not-equal-true", func(t *T) {
		t.Transform("not-equal-true")
		t.End()
	})

	Test(t, "conditions/remove-boolean: no report: no-boolean", func(t *T) {
		t.NoReport("no-boolean")
		t.End()
	})

	Test(t, "conditions/remove-boolean: no report: arithmetic", func(t *T) {
		t.NoReport("arithmetic")
		t.End()
	})

	Test(t, "conditions/remove-boolean: no report: not-boolean-literal", func(t *T) {
